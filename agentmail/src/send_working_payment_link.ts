...
async function sendWorkingPaymentLink() {
  console.log('🚀 Sending Working Payment Link Demo...\n');
...
🔗 **Payment Link**: ${workingCheckoutUrl}
...
Your Demo Team 🚀`
    ...
    console.log(`🔗 Working Payment Link: ${workingCheckoutUrl}`);
